...
public class Config {
    public static final String INSTALL_DIR = "/Users/joaocoelho/Documents/Work/UNN/unn-datacenter";
    public static final String DATA_DIR = INSTALL_DIR + "/src/main/data";
